...
<!-- body -->
<div id="sum-body-container" class="bodycontainer grid-y">
  <div id="sum-shelves" class="shelves">
    <div class="shelves__chatbox bg-primary py-3">
      <div class="container">
        <h5>What's the title of the book you are interested in?</h5>
        <input id="book-title" class="js-book-title" placeholder="e.g., The 7 Habits of Highly Effective People by Stephen Covey"></input>
        <a class="btn btn-secondary js-generate-summary">TELL ME ABOUT IT!</a>
        <h5 class="js-status ">Summary</h5>
        <textarea disabled rows="20" id="book-summary" class="js-book-summary"></textarea>
      </div>
    </div>
    <div class="container py-3">
      <h1>Book Shelves</h1>
      <div class="shelves__list">
        <div class="card flex"><h5>Book 1</h5></div>
        <div class="card flex"><h5>Book 2</h5></div>
        <div class="card flex"><h5>Book 3</h5></div>
        <div class="card flex"><h5>Book 4</h5></div>
        <div class="card flex"><h5>Book 5</h5></div>
        <div class="card flex"><h5>Book 6</h5></div>
      </div>
    </div>
  </div>
  <!-- /footer -->
